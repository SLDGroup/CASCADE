...
Official Pytorch implementation of [Medical Image Segmentation via Cascaded Attention Decoding, WACV 2023](https://openaccess.thecvf.com/content/WACV2023/html/Rahman_Medical_Image_Segmentation_via_Cascaded_Attention_Decoding_WACV_2023_paper.html).  
[GAIN 2023 best poster award](https://sites.utexas.edu/gain/previous-winners/prev-gain-2023-posterwinners), The Texas Health Catalyst Award 2024.
<br>
...
### Pretrained model:
You should download the pretrained PVTv2 model from [Google Drive](https://drive.google.com/drive/folders/1d5F1VjEF1AtTkNO93JwVBBSivE8zImiF?usp=share), and then put it in the './pretrained_pth/pvt/' folder for initialization. 
